package com.yan.beauty_shop_spring2.constants;

public class Constants {
    public static final String HOMEPAGE = "/homepage/";
    public static final String INDEX_JSP = "/index.jsp";
    public static final String H0ME_JSP = "home.jsp";
    ...
    public static final String FILTERBYDATE = "filterByDate";
    ...
    public static final String SQL_TIMESLOT_ID = "timeslot.id";
    public static final String SQL_A_LOGIN = "A.login";
